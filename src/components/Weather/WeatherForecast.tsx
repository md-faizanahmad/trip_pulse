...
export default function WeatherForecast({ forecast }: WeatherForecastProps) {
  ...
  return (
    <section className="mt-10">
      ...
      <div className="flex snap-x snap-mandatory gap-3 overflow-x-auto pb-3 [-ms-overflow-style:none] scrollbar-none [&::-webkit-scrollbar]:hidden sm:grid sm:grid-cols-2 sm:overflow-visible sm:pb-0 lg:grid-cols-4 xl:grid-cols-7">
