  ...
  return (
    <section className="w-full border-t border-zinc-200 bg-white px-4 py-10 sm:px-6 sm:py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-xs font-medium leading-6 text-zinc-500 sm:text-sm">
          TripPulse brings useful destination information together in one place,
          so you can understand a place before you arrive. Check local time,
          currency, transport, attractions, and safety information without
