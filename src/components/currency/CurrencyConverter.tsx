    ...
    <section className="space-y-4 p-4 sm:p-5 border-t border-zinc-100 pt-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
        ...
        <button
          type="button"
          onClick={handleSwap}
          className="flex h-10 w-10 shrink-0 items-center justify-center self-end rounded-md border border-zinc-200 bg-white text-lg text-zinc-600 transition hover:bg-zinc-50 hover:text-zinc-900"
